...
public:
	...
	Monster(string png_path, float newdirx, float newdiry)
	{
	...
	{
		string png_path = "img/monsterBeamRed2.png";
		for (int a = 0; a < beamSize; a++)
		{
			if (beam[a] == nullptr)
			{
				...
				beam[a]->sprite.setPosition(beam[a]->sprite.getPosition().x + 200, beam[a]->sprite.getPosition().y + 150);
				break;
			}
		}
	}
